...
(() => {
  ...
  function renderPuzzle(i) {
    ...
    // ta bort all tidigare progress‐text
    progEl.textContent = '';
  ...
  function checkAnswer(p,inputEl,msgEl,hintEl,card) {
    ...
    switch(p.type) {
      ...
      case 'stego':
      case 'audio':
      case 'prime':  ok = ans===String(p.answer); break;
      case 'morse': {
